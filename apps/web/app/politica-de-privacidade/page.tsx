    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none text-sm text-gray-600 dark:text-gray-300 leading-relaxed space-y-6">
          <p>
            No <strong>PDFRápido</strong>, acessível em <a href="https://pdfrapido.com.br" className="text-brand-600 dark:text-brand-400 hover:underline">pdfrapido.com.br</a>, uma de nossas principais prioridades é a privacidade dos nossos visitantes. Este documento contém os tipos de informações que são coletadas e registradas pelo PDFRápido e como as utilizamos.
          </p>

          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">1. Segurança dos Seus Arquivos (Exclusão Automática)</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">2. Arquivos de Log (Log Files)</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">3. Cookies e Web Beacons</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">4. Cookie Google DoubleClick DART</h2>
          <p>
            ...
            Os visitantes podem optar por recusar o uso de cookies DART visitando a Política de Privacidade da rede de conteúdo e anúncios do Google no seguinte URL: <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" className="text-brand-600 dark:text-brand-400 hover:underline">https://policies.google.com/technologies/ads</a>.
          </p>

          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">5. Nossos Parceiros de Publicidade</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">6. Consentimento</h2>
          <p>
