  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-6">Termos de Uso</h1>
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none text-sm text-gray-600 dark:text-gray-300 leading-relaxed space-y-6">
          <p>
            Bem-vindo ao <strong>PDFRápido</strong>! Ao acessar o nosso website em <a href="https://pdfrapido.com.br" className="text-brand-600 dark:text-brand-400 hover:underline">pdfrapido.com.br</a>, você concorda em cumprir e estar vinculado aos seguintes termos de uso. Se você não concordar com qualquer parte destes termos, não deverá utilizar nosso site.
          </p>

          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">1. Aceitação dos Termos</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">2. Descrição do Serviço</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">3. Uso Permitido e Responsabilidade do Usuário</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">4. Limitação de Responsabilidade</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">5. Alterações nos Termos</h2>
          <p>
