          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <div className="space-y-4 not-prose">
              {FAQ_ITEMS.map((item, idx) => (
                <div key={idx} className="bg-gray-50 dark:bg-gray-850 p-5 rounded-2xl border border-gray-200 dark:border-gray-800">
                  <h4 className="font-bold text-gray-900 dark:text-gray-100 text-sm md:text-base">{item.q}</h4>
