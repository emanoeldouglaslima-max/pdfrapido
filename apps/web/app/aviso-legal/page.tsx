  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-6">Aviso Legal</h1>
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none text-sm text-gray-600 dark:text-gray-300 leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">1. Isenção de Responsabilidade sobre Conteúdo</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">2. Responsabilidade pelos Arquivos Enviados</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">5. Alterações no Aviso Legal</h2>
          <p>
