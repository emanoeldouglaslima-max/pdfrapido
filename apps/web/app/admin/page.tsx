...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col md:flex-row text-gray-800 dark:text-gray-100">
      ...
      <main className="flex-grow p-6 md:p-10 max-w-5xl">
        ...
        <header className="flex justify-between items-center mb-8 pb-4 border-b border-gray-200 dark:border-gray-800">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Painel de Administração</h1>
            <p className="text-xs text-gray-400 dark:text-gray-400 mt-1">Gerencie artigos, monitoramento de robôs e conformidade AdSense</p>
          </div>
          <div className="flex items-center gap-2 text-xs font-semibold bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 px-3.5 py-2 rounded-xl shadow-sm text-green-600 dark:text-green-400">
        ...
        {activeTab === 'artigos' && (
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm">
              <h3 className="font-bold text-gray-900 dark:text-white mb-4 text-base">Escrever Novo Artigo</h3>
              <form onSubmit={handleAddArticle} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="md:col-span-3">
                    <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase">Título do Post</label>
                    <input
                      type="text"
                      placeholder="Ex: Como Reduzir PDF no Windows 11..."
                      value={newTitle}
                      onChange={(e) => setNewTitle(e.target.value)}
                      className="w-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-brand-500 focus:outline-none placeholder-gray-300 dark:placeholder-gray-500"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase">Categoria</label>
                    <select
                      value={newCategory}
                      onChange={(e) => setNewCategory(e.target.value)}
                      className="w-full border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-sm bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-brand-500 focus:outline-none"
                    >
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl shadow-sm overflow-hidden">
              <div className="p-6 border-b border-gray-100 dark:border-gray-800">
                <h3 className="font-bold text-gray-900 dark:text-white text-base">Artigos de Blog Ativos</h3>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                  <thead className="bg-gray-50 dark:bg-gray-800/60 text-xs text-gray-400 dark:text-gray-300 font-bold uppercase border-b border-gray-150 dark:border-gray-700">
                    <tr>
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    {articles.map((art) => (
                      <tr key={art.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
                        <td className="px-6 py-4 font-bold text-gray-900 dark:text-white">{art.title}</td>
        ...
        {activeTab === 'seo' && (
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm space-y-6">
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white text-base mb-1">Métricas Globais e XML Sitemap</h3>
              <p className="text-xs text-gray-400 dark:text-gray-400">Verifique a situação de indexação e estrutura técnica das páginas do site.</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700/60 p-5 rounded-2xl">
                <span className="text-2xl">📁</span>
                <h4 className="font-bold text-gray-900 dark:text-white text-sm mt-2 mb-1">Rotas Indexáveis</h4>
                <p className="text-xs text-gray-500 dark:text-gray-400">24 páginas ativas declaradas no sitemap.</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700/60 p-5 rounded-2xl">
                <span className="text-2xl">🤖</span>
                <h4 className="font-bold text-gray-900 dark:text-white text-sm mt-2 mb-1">Robots.txt</h4>
                <p className="text-xs text-green-600 dark:text-green-400 font-semibold">Ativo e rastreável</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700/60 p-5 rounded-2xl">
                <span className="text-2xl">🔗</span>
                <h4 className="font-bold text-gray-900 dark:text-white text-sm mt-2 mb-1">Canonicals</h4>
                <p className="text-xs text-green-600 dark:text-green-400 font-semibold">100% Otimizados (sem Punycode)</p>
              </div>
            </div>

            <div className="border-t border-gray-100 dark:border-gray-800 pt-6 space-y-4">
              <h4 className="font-bold text-gray-900 dark:text-white text-sm">Controle de Schema.org (JSON-LD)</h4>
        ...
        {activeTab === 'comentarios' && (
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-gray-100 dark:border-gray-800">
              <h3 className="font-bold text-gray-900 dark:text-white text-base">Moderação de Comentários</h3>
            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-800">
              {comments.length === 0 ? (
                ...
                comments.map((comm) => (
                  <div key={comm.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors flex flex-col sm:flex-row justify-between items-start gap-4">
                    <div className="space-y-1.5 max-w-xl">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-gray-900 dark:text-white text-sm">{comm.author}</span>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/60 p-3 rounded-xl border border-gray-100 dark:border-gray-700/60 italic">&quot;{comm.content}&quot;</p>
                    </div>
                      ...
                      {comm.status === 'Pendente' ? (
                        <>
                          ...
                          <button
                            ...
                            className="border border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-950/40 text-red-600 dark:text-red-400 font-bold text-xs px-3.5 py-1.5 rounded-xl active:scale-[0.98] transition-all"
                          >
                            Rejeitar
                          </button>
                        </>
                      ) : (
                        <span className="px-3 py-1 rounded-full text-xs font-bold bg-green-50 dark:bg-green-950/40 text-green-700 dark:text-green-400 flex items-center gap-1">
                          ✓ Aprovado
                        </span>
                      )}
                    </div>
        ...
        {activeTab === 'config' && (
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm space-y-6">
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white text-base mb-1">Tags de Monitoramento e Ferramentas do Google</h3>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase">Google AdSense (ID de Editor)</label>
                <input
                  type="text"
                  disabled
                  value="ca-pub-8269194570705692"
                  className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2.5 text-sm text-gray-400 cursor-not-allowed"
                />
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase">ID do Google Analytics 4 (GA_ID)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1.5 uppercase">Microsoft Clarity Project ID</label>
                  <input
                    type="text"
