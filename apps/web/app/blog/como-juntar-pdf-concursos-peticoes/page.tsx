    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400 dark:text-gray-400 mb-6 font-semibold">
          ...
          <span>/</span>
          <span className="text-gray-600 dark:text-gray-300">Juntar PDFs para Concursos</span>
        </div>
        ...
        <article>
          ...
          */}
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 leading-relaxed space-y-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">1. Por que os editais exigem um único arquivo PDF?</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">2. Passo a Passo: Unificando seus PDFs</h2>
            <p>
              Com o PDFRápido, o processo é simples e direto:
            </p>
            <ol className="list-decimal pl-5 space-y-3">
              <li>Acesse nossa ferramenta de <Link href="/juntar-pdf" className="text-brand-600 dark:text-brand-400 font-bold hover:underline">Juntar PDF</Link>.</li>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">3. Dicas para concursos públicos</h2>
            <p>
              Editais de concursos são extremamente rigorosos com o formato dos documentos. Aqui vão algumas dicas essenciais:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li><strong>Respeite o limite de tamanho:</strong> Muitos editais definem um limite de 5MB ou 10MB por arquivo. Se o PDF unificado ficar maior que o permitido, use nosso <Link href="/comprimir-pdf" className="text-brand-600 dark:text-brand-400 font-bold hover:underline">Compressor de PDF</Link> para reduzi-lo antes do envio.</li>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">4. Dicas para petições jurídicas (PJe e Tribunais)</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">5. Resumo: Fluxo completo para envio de documentos</h2>
            <p>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>Se necessário, converta as imagens JPG em PDF usando nosso <Link href="/converter-jpg-para-pdf" className="text-brand-600 dark:text-brand-400 font-bold hover:underline">Conversor JPG para PDF</Link>.</li>
              <li>Junte tudo em um único PDF com a ferramenta <Link href="/juntar-pdf" className="text-brand-600 dark:text-brand-400 font-bold hover:underline">Juntar PDF</Link>.</li>
