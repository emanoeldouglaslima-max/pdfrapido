...
export const ARTICLES = [
  {
    slug: 'como-transcrever-audio-de-reunioes-e-aulas',
    title: 'Como Transcrever Áudios de Reuniões, Aulas e Entrevistas em Texto com Facilidade',
    ...
    tags: ['Transcrição', 'Áudio', 'Produtividade', 'Word'],
    emoji: '🎙️',
    bgGradient: 'from-emerald-500/10 to-teal-500/10',
    iconColor: 'bg-emerald-100 text-emerald-700',
  },
  {
    slug: 'como-organizar-documentos-pdf-para-declaracao-imposto-de-renda',
    ...
    tags: ['Organização', 'Imposto de Renda', 'Compressão'],
    emoji: '💼',
    bgGradient: 'from-blue-500/10 to-indigo-500/10',
    iconColor: 'bg-blue-100 text-blue-700',
  },
  {
    slug: 'guia-completo-assinatura-eletronica-gov-br',
    title: 'Guia Completo de Assinatura Eletrônica pelo Gov.br: Como Fazer e Validade Jurídica',
    ...
    readTime: '6 min de leitura',
    category: 'Jurídico',
    tags: ['Assinatura', 'Gov.br', 'Segurança', 'Jurídico'],
    emoji: '🏛️',
    bgGradient: 'from-amber-500/10 to-yellow-500/10',
    iconColor: 'bg-amber-100 text-amber-700',
  },
  {
    slug: 'como-converter-pdf-para-excel-guia-pratico',
    title: 'Como Converter Tabelas de PDF para Excel e Planilhas sem Desconfigurar Colunas',
    ...
    readTime: '5 min de leitura',
    category: 'Conversor',
    tags: ['Conversão', 'Excel', 'Tabelas'],
    emoji: '📊',
    bgGradient: 'from-indigo-500/10 to-cyan-500/10',
    iconColor: 'bg-indigo-100 text-indigo-700',
  },
  {
    slug: 'como-proteger-pdf-com-senha-forte',
    title: 'Como Proteger Arquivos PDF com Senha e Criptografia Forte no Computador e Celular',
  ...
  {
    slug: 'como-extrair-texto-de-pdf-e-documentos-digitalizados',
    title: 'Como Extrair Textos de PDFs e Documentos Digitalizados sem Digitar Nada Manualmente',
    ...
    readTime: '5 min de leitura',
    category: 'Conversor',
    tags: ['Conversão', 'Word', 'Produtividade'],
    emoji: '📝',
    bgGradient: 'from-purple-500/10 to-violet-500/10',
    iconColor: 'bg-purple-100 text-purple-700',
  },
  {
    slug: 'melhores-praticas-para-digitalizar-documentos-com-celular',
    title: 'Melhores Práticas para Digitalizar Documentos com a Câmera do Celular em Alta Resolução',
    ...
    category: 'Conversor',
    tags: ['Celular', 'Conversão', 'Organização'],
    emoji: '📱',
    bgGradient: 'from-sky-500/10 to-blue-500/10',
    iconColor: 'bg-sky-100 text-sky-700',
  },
  {
    slug: 'como-otimizar-pdf-para-concursos-e-vestibulares',
    title: 'Como Otimizar e Reduzir PDFs para Envio em Portais de Concursos e Vestibulares',
    ...
    readTime: '5 min de leitura',
    category: 'Organização',
    tags: ['Concursos', 'Compressão', 'Organização'],
    emoji: '🎯',
    bgGradient: 'from-red-500/10 to-rose-500/10',
    iconColor: 'bg-red-100 text-red-700',
  },
  {
    slug: 'como-converter-video-mp4-em-texto-e-legendas',
    ...
    readTime: '5 min de leitura',
    category: 'Produtividade',
    tags: ['Transcrição', 'Vídeo', 'Produtividade'],
    emoji: '🎬',
    bgGradient: 'from-teal-500/10 to-emerald-500/10',
    iconColor: 'bg-teal-100 text-teal-700',
  },
  {
    slug: 'como-mesclar-contratos-e-anexos-em-um-unico-pdf',
    title: 'Como Mesclar Contratos, Comprovantes e Anexos em um Único Arquivo PDF Profissional',
    ...
    readTime: '5 min de leitura',
    category: 'Jurídico',
    tags: ['Jurídico', 'Organização', 'Contratos'],
    emoji: '📑',
    bgGradient: 'from-orange-500/10 to-amber-500/10',
    iconColor: 'bg-orange-100 text-orange-700',
  },
  {
    slug: 'como-converter-documentos-google-docs-para-pdf',
    ...
    readTime: '4 min de leitura',
    category: 'Produtividade',
    tags: ['Google Docs', 'Conversão', 'Produtividade'],
    emoji: '📄',
  ...
  {
    slug: 'como-recuperar-e-consertar-pdf-corrompido',
    ...
    readTime: '5 min de leitura',
    category: 'Organização',
    tags: ['Organização', 'Segurança', 'Recuperação'],
    emoji: '🛠️',
