    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400 dark:text-gray-400 mb-6 font-semibold">
          ...
          <span>/</span>
          <span className="text-gray-600 dark:text-gray-300">Assinar PDF com Certificado Digital</span>
        </div>
        ...
        <article>
          ...
          */}
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 leading-relaxed space-y-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">1. Quais tipos de assinatura eletrônica existem no Brasil?</h2>
            <p>
            ...
            <div className="overflow-x-auto my-6">
              <table className="min-w-full text-left text-sm border-collapse border border-gray-200 dark:border-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-800 font-bold text-gray-700 dark:text-gray-200">
                  <tr>
                    <th className="p-3 border border-gray-200 dark:border-gray-700">Tipo de Assinatura</th>
                    <th className="p-3 border border-gray-200 dark:border-gray-700">Como Funciona</th>
                    <th className="p-3 border border-gray-200 dark:border-gray-700">Exemplo Prático</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-150 dark:divide-gray-700 text-gray-600 dark:text-gray-300">
                  <tr>
                    <td className="p-3 border border-gray-200 dark:border-gray-700 font-semibold">Simples</td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700">Identifica quem está assinando através de dados básicos associados (IP, e-mail).</td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700">Aceitar termos de uso online ou assinar recibos comuns de entrega.</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-gray-200 dark:border-gray-700 font-semibold">Avançada</td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700">Usa dados criptográficos confiáveis que garantem que o documento não foi alterado após a assinatura.</td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700">Assinatura gratuita do Gov.br para contratos e declarações.</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-gray-200 dark:border-gray-700 font-semibold">Qualificada</td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700">Utiliza um certificado digital padrão ICP-Brasil (Tokens físicos, e-CPF, e-CNPJ) comprado em certificadoras.</td>
                    <td className="p-3 border border-gray-200 dark:border-gray-700">Assinatura de juízes, médicos (receitas), ou grandes transações imobiliárias.</td>
                  </tr>
                </tbody>
              </table>
            </div>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">2. Como usar a Assinatura Eletrônica Grátis do Gov.br</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">3. Cuidados essenciais ao assinar documentos digitais</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Verifique os limites de tamanho:</strong> O portal do Gov.br tem um limite máximo de tamanho de arquivo (geralmente de 100MB). Se o seu documento for muito grande, passe-o antes na nossa ferramenta de <Link href="/comprimir-pdf" className="text-brand-600 dark:text-brand-400 font-bold hover:underline">Comprimir PDF</Link>.</li>
            </ul>
            ...
            <div className="bg-brand-50 dark:bg-gray-800 border border-brand-100 dark:border-gray-700 p-8 rounded-3xl text-center space-y-4 my-8 not-prose">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Seu PDF está muito pesado para o assinador?</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">4. Como verificar se uma assinatura em PDF é válida?</h2>
            <p>
